...
def verify_title():
    ...
    show_background_option = driver.find_element("xpath", "//div[@role='button' and @aria-label='Show Background Options']")
    ...
    choose_background_option = driver.find_element("xpath", "//div[@role='button' and @aria-label='Gradient, red blue, background']")
    choose_background_option.click()

    # Hide background options
    hide_background_option = driver.find_element("xpath", "//div[@role='button' and @aria-label='Hide Background Options']")
    ...
    recently_used_emoji_first = driver.find_element("xpath", "//div[@role='rowgroup' and @aria-label='Recently Used']/div[2]/div/div[1]/div[@role='button']")
